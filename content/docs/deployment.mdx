...
> Part of the [docs index](/docs). For local setup, see [getting started](/docs/getting-started).
...
Required env on every target: `DATABASE_URL`, `BETTER_AUTH_SECRET`, `BETTER_AUTH_URL` (see [environment-variables.md](/docs/environment-variables)).
...
See [environment-variables.md](/docs/environment-variables) for the full list.
