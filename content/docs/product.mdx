...
Treat decentralized methods as first-class **sign-in and account-link** paths on the IdP. Protocol-specific OAuth scopes may be reserved for resources — see [client-trust-model.md](/docs/client-trust-model).
...
Discovery and protocol surfaces are documented in [features.md](/docs/features).

## See also

- [Features](/docs/features) — what ships today  
- [Getting started](/docs/getting-started) — local setup  
- [Deployment](/docs/deployment) — hosts and sync  
- [Admin panel](/docs/admin-panel) — OAuth clients  
