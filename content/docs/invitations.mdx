...
> Part of the [docs index](/docs). Related: [features](/docs/features) · [admin panel](/docs/admin-panel) · [TypeScript shim](/docs/typescript-better-invite).
...
1. Promote an admin (see [admin panel](/docs/admin-panel)). With invite-only enabled, create the first account before (or as) the bootstrap user, then promote.
...
- After upgrading `better-auth` or `better-invite`, see [typescript-better-invite.md](/docs/typescript-better-invite) for the `$ERROR_CODES` shim.
