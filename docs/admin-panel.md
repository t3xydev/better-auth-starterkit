...
> Part of the [docs index](./README.md). Related: [features](./features.md) · [environment variables](./environment-variables.md).
...
**Local development** — use Better Auth DevTools (floating panel in `next dev`) to create an Admin test user, or sign up and promote via SQL below.

**Production / first real admin** — sign up normally, then promote in PostgreSQL:
