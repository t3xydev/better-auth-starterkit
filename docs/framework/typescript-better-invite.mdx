---
title: "TypeScript: better-invite"
description: "Plugin type shim used in this repo."
---

This project uses **better-invite** alongside [Better Auth](https://www.better-auth.com/) 1.7.x. A **type-level mismatch** between the two packages can break TypeScript’s inference for *all* Better Auth plugins—not only invites.
...
- Admin panel and OAuth client APIs: [admin-panel.md](/docs/framework/admin-panel).
