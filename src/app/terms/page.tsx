    ...
    return (
        <main className="container flex flex-col gap-4 self-center p-4 text-sm md:p-6">
            ...
            <p>
                ...
                Starter. Better Auth Starter offers this website, including all
            ...
            <p>
                ...
                laws). You must not transmit any worms or viruses or any code of
                a destructive nature. A breach or violation of any of the Terms
            ...
            <p>
                ...
                contact you as needed. For more detail, please review our
                Returns Policy.
            </p>
